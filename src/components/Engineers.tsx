        ...
        <div className="item" key={"new-engineer"}>
          <div className="right floated content">
            <div
              ...
              onClick={() => {
                props.add("engineers", { name, accomplishment });
                resetInputs();
              }}
            >
              Add
          ...
          <div className="content">
            {
              <div className="ui transparent input">
                ...
                <input
                  type="text"
                  placeholder=" Engineer Accomplishment"
        ...
        {engineers.map((engineer) => (
          <div className="item" key={engineer.id}>
            <div className="right floated content">
              <div
                className="ui  button"
                onClick={() => props.delete("engineers", engineer.id as number)}
              >
                Delete
              </div>
            </div>
            <div className="content">
              {engineer.name} <span>managed to create</span>{" "}
